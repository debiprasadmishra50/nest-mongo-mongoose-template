...
export class AuthController {
  ...
  @ApiOperation({
    ...
    summary: "Api to register new users. It taked (firstName, lastName, email and password) as input",
  })
  @ApiCreatedResponse({
  ...
  async sendAccountActivationToken(@GetUser() user: User, @Req() req: Request) {
    ...
    return status ? { status, message: "Activation mail sent successfully!" } : "";
  }
}
